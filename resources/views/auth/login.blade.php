...
<section class=" text-center text-lg-start vh-100">
  ...
  <div class="card">
    ...
    <div class="row g-0 d-flex align-items-center ">
      ...
      <div class="col-lg-8">
       <h1 class="text-center text-primary" >Customer Login Page</h1>
       <div class="card-body py-2 px-md-5">
          ...
          <form>
            ...
            <!-- Submit button -->
            <button type="submit" class="btn btn-primary mb-4"><i class="fa fa-sign-in me-2"></i>Login</button>
          </form> 
            @if (session('banMessage'))
              <div class="alert alert-danger">{{ session('banMessage') }}</div>
            @else
              <div class="card bg-light mb-0">  
                <div class="card-body text-center">
                  <h4 class="text-primary">Not our registered customer yet? </h4>
                  <p class=" text-muted"> 
